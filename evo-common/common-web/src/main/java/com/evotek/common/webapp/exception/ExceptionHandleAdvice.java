package com.evotek.common.webapp.exception;

import com.evotek.common.dto.error.ErrorResponse;
import com.evotek.common.dto.error.FieldErrorResponse;
import com.evotek.common.dto.error.InvalidInputResponse;
import com.evotek.common.error.*;
    ...
    public ResponseEntity<ErrorResponse<Void>> handleValidationException(
        ...
        return ResponseEntity.status(HttpStatus.FORBIDDEN)
                .body(ErrorResponse.<Void>builder()
                        ...
                        .message(localeStringService.getMessage(AuthorizationError.ACCESS_DENIED.getName(), "Access Denied"))
