...
import com.evotek.common.webapp.security.TokenCacheService;
...
public class TokenCacheServiceImpl implements TokenCacheService {
    ...
    public void invalidToken(String token) {
        try {
            ...
            log.error("Cache manager check invalid token error", ex);
        }
    }
    ...
    public void invalidRefreshToken(String refreshToken) {
        try {
            ...
            log.error("Cache manager check invalid refresh token error", ex);
        }
    }
}
